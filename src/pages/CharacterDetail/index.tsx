...
export default function CharacterDetail() {
  ...
  useEffect(() => {
    ...
    api.get(`https://gateway.marvel.com/v1/public/characters/${id}?ts=1616179034&apikey=c22ba519d36ef5d64b7c341b94e6c7f9&hash=8a8b24fa59c32ba7bb0920b0c2721d86`).then((response) => {
      setCharacterDetails(response.data.data.results[0]);
    }).catch((error) => {
      console.error(error)
    })

    api.get(`https://gateway.marvel.com/v1/public/characters/${id}/comics?ts=1616179034&apikey=c22ba519d36ef5d64b7c341b94e6c7f9&hash=8a8b24fa59c32ba7bb0920b0c2721d86`).then((response) => {
